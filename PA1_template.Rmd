...
```
![plot of chunk plot1](figure/unnamed-chunk-3-1.png) 
...
The mean steps per day is `r mean`, while the median is `r median`.
...
```
![plot of chunk plot1](figure/unnamed-chunk-5-1.png) 
...
So the interval: `r max_avg_steps` has the most average steps.
...
```
![plot of chunk plot1](figure/unnamed-chunk-9-1.png) 

The mean steps per day is `r mean_new`, while the median is `r median_new`. See the change in the histogram. As expected, the mean and median are different, since instead of ignoring NA values, we filled in the missing data with averages. This data set shows a decrease since the data is skewed to the left.
...
```
![plot of chunk plot1](figure/unnamed-chunk-11-1.png) 
